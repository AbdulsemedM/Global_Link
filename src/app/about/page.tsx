...
const teamMembers = [
  ...
  },
  {
    ...
    image: 'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=300&h=300&q=80',
  },
]
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-200">
              Building bridges across oceans, connecting businesses worldwide
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300">
                To revolutionize global logistics through innovation, reliability, and sustainable practices, making international trade accessible and efficient for businesses of all sizes.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Our experienced team of professionals is dedicated to providing exceptional service and innovative solutions.
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              {
                title: 'Reliability',
                description: 'Delivering consistent, dependable service that our clients can count on.',
              },
              {
